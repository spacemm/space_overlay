...
SLOT="0"
KEYWORDS=""
IUSE="+blkid debug doc floppy gudev hwdb introspection keymap +kmod +openrc selinux static-libs"
...
COMMON_DEPEND="blkid? ( >=sys-apps/util-linux-2.20 )
	gudev? ( dev-libs/glib:2 )
	introspection? ( >=dev-libs/gobject-introspection-1.31.1 )
	kmod? ( >=sys-apps/kmod-5 )
...
src_install() {
	...
	dodoc LICENSE.GPL LICENSE.LGPL README INSTALL 
